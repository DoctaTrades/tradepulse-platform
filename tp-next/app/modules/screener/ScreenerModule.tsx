...
export default function ScreenerModule() {
  ...
  return (
    <div className="relative z-10 min-h-screen">
      {/* HEADER */}
      <header className="sticky top-0 z-50 flex items-center justify-between px-7 py-3.5 border-b backdrop-blur-xl" style={{ borderColor: 'var(--border)', background: 'rgba(11,17,32,0.97)' }}>
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg flex items-center justify-center font-display font-bold text-white text-sm" style={{ background: 'linear-gradient(135deg, var(--blue), var(--blue2))', boxShadow: '0 0 20px rgba(30,79,216,0.4)' }}>PR</div>
          <div>
            <div className="font-display text-lg font-bold tracking-wider">PULSE RADAR</div>
            <div className="font-mono text-[9px] tracking-widest uppercase" style={{ color: 'var(--gold)' }}>Options Screener v1.0</div>
          </div>
        </div>
        <div className="flex items-center gap-5">
          <div className="text-right">
            <div className="font-display text-lg font-bold" style={{ color: 'var(--blue3)' }}>{results.length || '—'}</div>
            <div className="font-mono text-[9px] uppercase tracking-wider" style={{ color: 'var(--text-dim)' }}>Results</div>
          </div>
          <div className="text-right">
            <div className="font-display text-lg font-bold" style={{ color: 'var(--blue3)' }}>{scanStats.scanned || '—'}</div>
            <div className="font-mono text-[9px] uppercase tracking-wider" style={{ color: 'var(--text-dim)' }}>Scanned</div>
          </div>
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full border" style={{ borderColor: 'var(--border)', background: 'var(--navy3)' }}>
            ...
            <span className="font-mono text-[10px]" style={{ color: 'var(--text-mid)' }}>
              {schwabStatus.connected ? 'SCHWAB' : scanning ? 'SCANNING' : 'READY'}
            </span>
          </div>
        </div>
      </header>
